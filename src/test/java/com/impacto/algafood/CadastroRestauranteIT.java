...
import com.impacto.algafood.util.DatabaseCleaner;
import com.impacto.algafood.util.ResourceUtils;
...
public class CadastroRestauranteIT {
    ...
    public void deveRetornarStatus400_QuandoCadastrarRestauranteComCozinhaInexistente() {
        ...
        .then()
            .statusCode(HttpStatus.BAD_REQUEST.value())
            .body("type", equalTo(VIOLACAO_DE_REGRA_DE_NEGOCIO_PROBLEM_TYPE))
            .body("title", equalTo(DADOS_INVALIDOS_PROBLEM_TITLE));
    }
    ...
    private void prepararDados() {
        ...
        Restaurante botecoDoGeraldinho = new Restaurante();
        botecoDoGeraldinho.setNome("Boteco do Geraldinho");
        botecoDoGeraldinho.setTaxaFrete(new BigDecimal(10));
        botecoDoGeraldinho.setCozinha(cozinhaBrasileira);
        restauranteRepository.save(botecoDoGeraldinho);
    }
}
